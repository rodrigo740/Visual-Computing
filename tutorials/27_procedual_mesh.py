...
from panda3d.core import OrthographicLens, GeomVertexFormat, GeomVertexData, GeomNode
from panda3d.core import TransparencyAttrib, Geom, GeomTriangles, GeomVertexWriter
...
def create_textured_rect(x, z, width, height, colors=None):
